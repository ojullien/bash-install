...
readonly m_INSTALL_PACKAGES_SYSTEM="dkms build-essential util-linux deborphan localepurge hdparm htop nmap tzdata debsums mailutils software-properties-common"
