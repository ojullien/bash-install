...
readonly m_INSTALL_PACKAGES_SYSTEM="dkms build-essential util-linux deborphan localepurge hdparm htop tzdata debsums mailutils software-properties-common"
